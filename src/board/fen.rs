...
mod test {
    ...
    fn parse_with_default_state() {
        ...
        assert_eq!(board.castling_rights(), ALL_RIGHTS);
    ...
    fn parse_with_ep_square_2() {
        ...
        assert!(result.is_ok());
        let board = result.unwrap();
        assert_eq!(board.ep_square().unwrap(), C3);
    }
    ...
    fn parse_with_half_move_clock_2() {
        ...
        assert!(result.is_ok());
        let board = result.unwrap();
        assert_eq!(board.half_move_clock(), 23);
    }
    ...
    fn parse_with_full_move_number_2() {
        ...
        assert!(result.is_ok());
        let board = result.unwrap();
        assert_eq!(board.full_move_number(), 45);
    }
    ...
    fn parse_with_castling_rights_1() {
        ...
        assert!(result.is_ok());
        let board = result.unwrap();
        assert_eq!(board.castling_rights(), NO_RIGHTS);
    }
    ...
    fn parse_with_castling_rights_2() {
        ...
        assert_eq!(board.castling_rights(), expected_rights);
    }
